...
module.exports = function(logger) {
    ...
    var insert = {
        ...
        maps: async function(map) {
            return await runQuery('INSERT INTO maps SET ? ON DUPLICATE KEY UPDATE name = VALUES(name)', map);
        },
        ...
        leaguePosition: async function(league) {
            return await runQuery(
                'INSERT INTO leaguePosition SET ? ON DUPLICATE KEY UPDATE leagueId = VALUES(leagueId), leagueName = VALUES(leagueName), tier = VALUES(tier), rank = VALUES(rank), summonerName = VALUES(summonerName), leaguePoints = VALUES(leaguePoints), wins = VALUES(wins), losses = VALUES(losses)',
                league
            );
        },
