...
module.exports = function (logger, api, db) {
    var getChampions = async function () {
        ...
        if (championsResult.data) {
            var champions = JSON.parse(championsResult.data).data;
    ...
    return {
        getChampions: getChampions, getItems: getItems, getMasteries: getMasteries, getRunes: getRunes, getSpells: getSpells
    };
};